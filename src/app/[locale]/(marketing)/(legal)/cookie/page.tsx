...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Cookie Policy | Desktop Explorer Wiki',
    description:
      'How Desktop Explorer Wiki uses essential cookies, analytics, and similar technologies.',
    locale,
    pathname: '/cookie',
  });
}
    ...
    <div className="bg-[#071615] py-12 text-[#f4f1df]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#a9c0bb]">
          Desktop Explorer Wiki uses essential cookies and similar technologies
        ...
        <p className="leading-8 text-[#a9c0bb]">
          Questions about this policy can be sent to hello@desktopexplorer.wiki.
        </p>
      </Container>
    </div>
  );

...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Terms of Service | Desktop Explorer Wiki',
    description:
      'Terms for using Desktop Explorer Wiki, an independent game guide site.',
    locale,
    pathname: '/terms',
  });
}
    ...
    <div className="bg-[#071615] py-12 text-[#f4f1df]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#a9c0bb]">
          This site provides independent Desktop Explorer guides, source notes
          and official-link guidance. It is not affiliated with, endorsed by,
          sponsored by or operated by Recurring Dream, Outersloth, indienova,
        ...
        <p className="leading-8 text-[#a9c0bb]">
          Questions about these terms can be sent to hello@desktopexplorer.wiki.
        </p>
      </Container>
    </div>
  );

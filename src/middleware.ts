...
const retiredPublicRouteRedirects: Array<{
  ...
  { pattern: /^\/combat(?:\/.*)?$/, target: '/guides' },
  {
    pattern: /^\/map(?:\/.*)?$/,
    target: '/guides/full-walkthrough',
  },
  ...
  {
    pattern: /^\/desktop-explorer-beginner-guide(?:\/.*)?$/,
    target: '/guides/beginner-spoiler-light-hints',
  },
  {
    pattern: /^\/desktop-explorer-map(?:\/.*)?$/,
    target: '/guides/full-walkthrough',
  },
  {
    pattern: /^\/desktop-explorer-download(?:\/.*)?$/,
    target: '/download',
  },
];
...
export default async function middleware(req: NextRequest) {
  ...
  const productionHosts = new Set([
    'desktopexplorer.wiki',
    'www.desktopexplorer.wiki',
  ]);
  const canonicalHost = 'www.desktopexplorer.wiki';

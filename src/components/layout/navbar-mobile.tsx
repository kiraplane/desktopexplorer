                ...
                {item.items ? (
                    ...
                    <CollapsibleTrigger asChild>
                      <Button
                        ...
                        className={cn(
                          ...
                          'hover:bg-transparent hover:text-[#f0a23a]',
                          'focus:bg-transparent focus:text-[#f0a23a]',
                          isActive &&
                            'font-semibold bg-transparent text-[#f0a23a]'
                        )}
                      >
                  ...
                  <LocaleLink
                    ...
                    className={cn(
                      ...
                      'hover:bg-transparent hover:text-[#f0a23a]',
                      'focus:bg-transparent focus:text-[#f0a23a]',
                      isActive && 'font-semibold bg-transparent text-[#f0a23a]'
                    )}
                    onClick={onLinkClicked}
                  >

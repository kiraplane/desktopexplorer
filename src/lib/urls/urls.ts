...
export const CANONICAL_BASE_URL = 'https://www.desktopexplorer.wiki';
...
function getDesktopExplorerBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'desktopexplorer.wiki' ||
      parsedUrl.hostname === 'www.desktopexplorer.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const desktopExplorerBaseUrl = getDesktopExplorerBaseUrl(configuredBaseUrl);
  if (desktopExplorerBaseUrl) {
    return desktopExplorerBaseUrl;
  }
